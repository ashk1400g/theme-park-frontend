...
export const appConfig = {
  // MODULE 1- BACKEND
  initStateAPI: 'https://fj2644rzb3.execute-api.us-west-2.amazonaws.com/Prod/InitState/', // e.g. https://12abcdef89.execute-api.us-west-2.amazonaws.com/Prod/InitState/
  // MODULE 2 - REALTIME
  iot: {
